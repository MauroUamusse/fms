...
<div class="container-fluid">
	<div class="col-lg-12">
		...
		<div class="row">
			<button class="btn btn-primary btn-sm" id="new_folder"><i class="fa fa-plus"></i> Nova pasta</button>
			<button class="btn btn-primary btn-sm ml-4" id="new_file"><i class="fa fa-upload"></i> carregar Ficheiro</button>
		</div>
		<hr>
		<div class="row">
			<div class="col-lg-12">
		...
		<div class="row">
			<div class="col-md-12"><h4><b>Pastas</b></h4></div>
		</div>
		<hr>
		<div class="row">
			<?php 
		...
		<div class="row">
			<div class="card col-md-12">
				<div class="card-body">
					<table width="100%">
						<tr>
							<th width="40%" class="">Nome do Ficheiro</th>
							<th width="20%" class="">Data de Cadastro</th>
							<th width="40%" class="">Descrição</th>
						</tr>
						<?php 
...
<div id="menu-folder-clone" style="display: none;">
	<a href="javascript:void(0)" class="custom-menu-list file-option edit">Mudar Nome</a>
	<a href="javascript:void(0)" class="custom-menu-list file-option delete">Apagar</a>
</div>
<div id="menu-file-clone" style="display: none;">
	<a href="javascript:void(0)" class="custom-menu-list file-option edit"><span><i class="fa fa-edit"></i> </span>Mudar Nome</a>
	<a href="javascript:void(0)" class="custom-menu-list file-option download"><span><i class="fa fa-download"></i> </span>Baixar</a>
	<a href="javascript:void(0)" class="custom-menu-list file-option delete"><span><i class="fa fa-trash"></i> </span>Apagar</a>
</div>
...
<script>
	...
	$("div.file.custom-menu .delete").click(function(e){
		e.preventDefault()
		_conf("Deseja Apagar este ficheiro?",'delete_file',[$(this).attr('data-id')])
	})
...
//FILE
	...
	function delete_folder($id){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					alert_toast("Pasta removida com sucesso.",'success')
						setTimeout(function(){
							location.reload()
						},1500)
				}

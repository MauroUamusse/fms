	...
	<form action="" id="manage-files">
		...
		<div class="input-group mb-3">
		  ...
		  <div class="custom-file">
		    ...
		    <label class="custom-file-label" for="upload">Selecione o Ficheiro</label>
		  </div>
		</div>
	<?php endif; ?>
		<div class="form-group">
		...
		<div class="form-group">
			<label for="is_public" class="control-label"><input type="checkbox" name="is_public" id="is_public"><i> Partilhar para todos</i></label>
		</div>
		...
		$.ajax({
			...
			success:function(resp){
				if(typeof resp != undefined){
					...
					if(resp.status == 1){
						alert_toast("Ficheiro adicionado com sucesso.",'success')
						setTimeout(function(){
							location.reload()
						},1500)
					}else{
